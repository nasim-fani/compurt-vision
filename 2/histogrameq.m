function finalResult = histogrameq(orginal)
...
subplot(2,2,1),imshow(finalResult),title('equlized image');
subplot(2,2,2),imhist(finalResult), title('equlized histogram');
subplot(2,2,3),imshow(orginal),title('original image');
subplot(2,2,4),imhist(orginal), title('original histogram');
